...
"CREATE TABLE user (id_User INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT NOT NULL, email TEXT NOT NULL, password TEXT NOT NULL)",
...
"INSERT INTO tag (name) values ('unregistered')",
"INSERT INTO tag (name) values ('registered')",
