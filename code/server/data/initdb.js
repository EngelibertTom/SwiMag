...
let query = [
  ...
  "INSERT INTO article (id, title, content, thumbnailURL, id_media, mediaURL) values ('1','SwiMag', '<h1>Hello from ecoal</h1><p>Nice to see you in <strong>Lens</strong>. Enjoy !</p>','ecoal.jpg', '1', 'ecoal.jpg')",
  "INSERT INTO article (id, title, content, thumbnailURL, id_media, mediaURL) values ('2','Swim for fitness', '<h1>Swimming is good for you...<strong>really good</strong>. Enjoy !</p>','ecoal.jpg', '2', 'ecoal.jpg')",
  "INSERT INTO article (id, title, content, thumbnailURL, id_media, mediaURL) values ('3','Learn to swim', '<h1>This is hoz you swim...</strong>. Enjoy !</p>','ecoal.jpg', '3', 'ecoal.jpg')",
